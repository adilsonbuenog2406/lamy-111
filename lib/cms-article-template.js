...
<article class="artigo-detail">
  <main class="artigo-detail__main">
    ...
    <img class="artigo-detail__hero-img" src="/assets/site-home/CAPA ARTIGO 01.jpg" alt="${safeTitle}" loading="lazy">
...
function extractArticleListingMeta(page) {
  ...
  const image =
    ...
    "/assets/site-home/CAPA ARTIGO 01.jpg";
  const excerpt =
...
function buildArticleListingCard({ title, path: articlePath, badge, readTime, image, excerpt }) {
  ...
  const safeImage = escapeHtml(image || "/assets/site-home/CAPA ARTIGO 01.jpg");
...
function applyListingMetaToCard(link, articleMeta) {
  ...
  const image = String(articleMeta.image || "/assets/site-home/CAPA ARTIGO 01.jpg").trim();
